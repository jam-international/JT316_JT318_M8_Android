...
{
    public enum TipiCodici{ OP1, OP2, OP3, SPEED1, SPEED2, SPEED3, TENS1, TENS2, TENS3,SPEED_M8,TENS_M8,ANGOLO_ROT,RASAFILO}
    public enum TipiValori { VALUE0, VALUE1}

    public TipiCodici tipoCodice;
    public TipiValori valore = TipiValori.VALUE0;
    public String valore_M8,Angolo_rotaz,Num_punti_rotaz;
