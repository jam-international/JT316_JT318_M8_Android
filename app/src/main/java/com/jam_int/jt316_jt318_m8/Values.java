...
public class Values {
    ...
    public static float dpFi1 =  3;
    public static float dpFf1 =  -1000;
    public static float dpFi2 =  3;
    public static float dpFf2 =  -1000;
    public static int type;
    public static int model;
    public static int model1;
    public static String Language="en";
    public static String Chiamante;
    public static String File_XML_path;
    public static String File_XML_path_R;
    public static String Machine_model;
    public static boolean Debug_mode = false;
	public static boolean Reload_XML_main_page = false;
	public static String Username = "";
    public static int UserLevel = 10;                           //Per ora sta a 10 poi diventerà 0
    public static String File;                                  //.pts scelto da disegnare
    public static Context Context;
    public static int ProductionCount;

    public static double UdfPuntiVelIni = 0.003d;
    public static int UdfVelIniRPM = 300;
    public static double UdfPuntiVelRall = 0.003d;
