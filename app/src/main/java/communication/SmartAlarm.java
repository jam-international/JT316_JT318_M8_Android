...
public class SmartAlarm
{
    ...
    public String getFingerPrint()
    {
        if (FingerPrint == null)
        {
            ...
            FingerPrint = hk.toString() + Active.toString() + CN.toString();
        }
    ...
    public Date GetCnDate(Integer SecTot)
    {
        ...
        tm_sec = (int) (SecTot % 60);
        SecTot /= 60;

        tm_min = (int) (SecTot % 60);
        SecTot /= 60;

        Integer Ip = (int) (SecTot / (1461 * 24));
        ...
        tm_hour = (int) (SecTot % 24);

        SecTot /= 24;

        tm_yday = (int) (1 + SecTot);
